 ...
 * @note -
 */
public class StatusLayout2 extends RelativeLayout {
    /** 隐藏 */
     ...
     * @param context 上下文
     */
    public StatusLayout2(final Context context, final View view) {
        super(context);
        ...
        view.post(new TimerTask() {
            ...
            public void run() {
                if (view.getParent() instanceof ViewGroup) {
                    ...
                    child.addView(view);
                    // 上层
                    child.addView(StatusLayout2.this);
     ...
     */
    public void showStatus(int status, OnClickListener retryClickListener) {
        if (status < 0) {
            setVisibility(View.GONE);
            return;
        }
